...
const CanvasEditor: React.FC<CanvasEditorProps> = () => {
  ...
  return (
    <div className="flex flex-1 h-full bg-gray-900 overflow-hidden">
        <div className="w-[270px] border-r border-gray-700 p-5 flex flex-col gap-4 overflow-y-auto shrink-0 text-gray-800 h-full z-10" style={{ backgroundColor: '#F0F1F4' }}>
            {/* 一键标准化 */}
